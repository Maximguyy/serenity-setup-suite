...
const HeroBanner = () => {
  ...
  return <section id="accueil" className="hero-banner" style={{
    position: 'relative',
    minHeight: '72vh',
    display: 'flex',
    ...
    overflow: 'hidden'
      ...
      zIndex: 0
        ...
        <picture>
          ...
          <img src={hero.backgroundImage.mobile} alt="Salon de beauté élégant avec ambiance zen" loading="eager" style={{
          width: '100%',
          height: '100%',
          objectFit: 'cover',
