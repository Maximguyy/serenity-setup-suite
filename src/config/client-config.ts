    ...
    categories: [
      {
        ...
        items: [
          { name: "HYDRASKIN EXPERT", duration: "60 min", price: "97€", originalPrice: undefined as string | undefined, image: "/assets/services/hydraskin.png", description: "Soin visage technologique combinant hydratation intense, nettoyage profond des pores et éclat de la peau." },
